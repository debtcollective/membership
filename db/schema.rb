...
ActiveRecord::Schema.define(version: 20_190_829_110_554) do
  ...
  create_table 'subscription_donations', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[subscription_id donation_id], name: 'index_subscription_donations_on_subscription_id_and_donation_id', unique: true
  ...
  create_table 'subscriptions', id: :uuid, default: -> { 'gen_random_uuid()' }, force: :cascade do |t|
    ...
    t.index %w[user_id plan_id active], name: 'index_subscriptions_on_user_id_and_plan_id_and_active', unique: true
